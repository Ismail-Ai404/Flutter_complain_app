...
if (isset($_POST['submit'])) {
	...
	$status = 1;
	$query = mysqli_query($bd, "insert into users(fullName,nsuID,userEmail,password,contactNo,status) values('$fullname', '$nsuid', '$email', '$password','$contactno','$status')");
...
<head>
	...
	<title>NSU | User Registration</title>
		...
		<div class="container">
			...
			<form class="form-login" method="post">
				...
				<div class="login-wrap">
					...
					<input type="text" class="form-control" maxlength="10" name="nsuID" placeholder="NSU ID" required="required" autofocus>
					<br>
